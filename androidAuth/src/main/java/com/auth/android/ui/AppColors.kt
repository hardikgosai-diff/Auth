...
object AppColors {
    ...
    const val focusedHexFormat = 0xFF404040
    const val unfocusedHexFormat = 0xFFE3E3E3
    const val errorHexFormat = 0xFFFF0000
    const val blueHexFormat = 0xFF07AAF2
    ...
    val focused = Color(focusedHexFormat)
    val unfocused = Color(unfocusedHexFormat)
    val error = Color(errorHexFormat)
    val blue = Color(blueHexFormat)
